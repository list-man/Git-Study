========================================================================
    ACTIVE TEMPLATE LIBRARY : IEProtectMode Project Overview
========================================================================

AppWizard has created this IEProtectMode project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

IEProtectMode.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

IEProtectMode.vcxproj.filters
...
IEProtectMode.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (IEProtectMode.h)
        GUID definitions                                (IEProtectMode_i.c)
        A type library                                  (IEProtectMode.tlb)
        Marshaling code                                 (IEProtectMode_p.c and dlldata.c)

IEProtectMode.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in IEProtectMode.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named IEProtectMode.pch and a precompiled types file named StdAfx.obj.
...
IEProtectModeps.vcxproj
	...
	dlldata.c, IEProtectMode_i.c and IEProtectMode_p.c which are required
	to build the proxy/stub DLL.

IEProtectModeps.vcxproj.filters
